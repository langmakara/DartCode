...
class Student extends Person {
  ...
  @override String get info => '${super.info}, score:$score';
  @override PersonType get type => PersonType.student;
  @override Person clone() => Student(name, age, score);
  @override String getTextData() => '${super.getTextData()}/$score';
  @override
