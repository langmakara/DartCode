...
class Worker extends Person {
  ...
  @override String get info => '${super.info}, factory:$factory';
  @override PersonType get type => PersonType.worker;
  @override Person clone() => Worker(name, age, factory);
  @override String getTextData() => '${super.getTextData()}/$factory';
  @override
